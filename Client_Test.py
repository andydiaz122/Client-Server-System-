...
import sys, xmlrpclib, pickle, time

print("There are 4 servers available to run")


starting_port_num = raw_input("Please give a 4-digit port number and press enter to start servers:\n")	
...
server1 = xmlrpclib.ServerProxy(server1_http)
print("connection established from server01.py")

server2 = xmlrpclib.ServerProxy(server2_http)
print("connection established from server02.py")

server3 = xmlrpclib.ServerProxy(server3_http)
print("connection established from server03.py")

server4 = xmlrpclib.ServerProxy(server4_http)
...
while 1:
	...
	command_and_argument_string = raw_input("$ ")
